            ...
            <Section className="max-w-7xl mx-auto px-6 lg:px-12 py-20">
                ...
                >
                    ...
                    <MethodCard 
                        ...
                        title="RESET"
                        description="We start by restoring metabolic balance. This phase focuses on reducing inflammation, improving digestion, regulating stress, and preparing your body for efficient fat loss."
                    ...
                    <MethodCard 
                        ...
                        title="REBUILD"
                        description="Once your system is balanced, we rebuild strength, nutrition, and daily habits using structured training, personalized diet strategies, and realistic lifestyle upgrades."
                        variants={itemVariants}
                    />
                    ...
                    <MethodCard 
                        Icon={IconRiseGrowth}
                        title="RISE"
                        description="The final phase is about independence. You gain clarity, confidence, and control — so you can maintain results, energy, and performance long after coaching ends."
                        variants={itemVariants}
                    />
                </motion.div>
            </Section>
