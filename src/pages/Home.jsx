    ...
    return (
        <div className="px-4">
            ...
            <motion.section 
                ...
                className="max-w-7xl mx-auto min-h-[80vh] flex flex-col justify-center relative overflow-hidden"
            >
                <motion.h1 variants={itemVariants} className="relative z-10 text-4xl md:text-6xl font-bold leading-tight">
                    Break Free From <motion.span 
                        initial={{ color: "#9CA3AF" }}
                        animate={{ color: "#FFFFFF" }}
                        transition={{ delay: 0.8, duration: 0.5 }} // Subtle highlight reveal
                        className="text-white"
                    >Stubborn Weight Gain</motion.span>
                    <br />
                    <motion.span variants={itemVariants} className="inline-block mt-2">Rebuild Your Energy. Reclaim Your Confidence.</motion.span>
                </motion.h1>

                <motion.p variants={itemVariants} className="relative z-10 text-brand-muted mt-6 text-lg max-w-2xl">
                    A science-backed 90-Day Lean Body Method trusted by hundreds to deliver real, lasting transformation — without gimmicks, pills, or crash diets.
                </motion.p>
